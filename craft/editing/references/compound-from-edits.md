...
Human edits are evidence about the system, not cleanup to be absorbed silently.

## Workflow

1. Preserve the AI draft and the edited version.
...
- The three to seven most important changes.
