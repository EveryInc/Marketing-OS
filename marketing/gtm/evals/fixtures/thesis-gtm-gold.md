<!-- Thesis GTM gold snapshot. Canonical source: https://app.notion.com/p/3b6ca4f355ac818fa739d2dd3a82d65d?pvs=204. Captured 2026-08-08. -->

**Launch:** Thursday, Aug. 13
**Campaign window:** Aug. 13–26
...
<tr>
<td>Free</td>
<td>Every is opening a public conversation about what happens after automation.</td>
<td>Read Thesis Statements and apply to attend.</td>
</tr>
<tr>
<td>Paid</td>
<td>Thesis is where Every members can work through these ideas with the people building and operating the future of work.</td>
<td>Apply to attend.</td>
</tr>
<tr>
<td>All Access</td>
<td>Priority consideration is a benefit of membership. Make that advantage explicit.</td>
<td>Apply with priority.</td>
</tr>
</table>
**DRI**: Douglas
...
- **Tuesday, Aug. 18:** Follow up personally with P1 non-responders. Start P2 outreach based on which builders, operators, executives, and industries are missing from the attendee mix.
Dan handles peer-credibility names; Douglas the rest.
**DRI**: Douglas
**Copy**: Douglas —\> KateBench —\> Kate edit/approval —\> Dan (for his own outreach emails)
**List Suppression: **Yash
**Due date:** Lock the plan Monday, Aug. 10; send Friday, Aug. 14.
## Editorial, Contributors, and Speakers
<empty-block/>
<table fit-page-width="true" header-row="true">
<tr>
<td>Date</td>
<td>Editorial Moment</td>
<td>Thesis Connection</td>
<td>Actual Statement + Why It Cross-Pollinates</td>
</tr>
<tr>
<td>Aug. 14</td>
<td>Nityesh's security guide</td>
<td>How does automation impact security? Good to discuss but not now.</td>
<td>N/A</td>
</tr>
<tr>
<td>Aug. 17</td>
<td>Agent Etiquette Guide</td>
<td>What new norms do humans and agents need to work together after automation?</td>
<td>[Noah Brier](https://every.to/thesis/the-culture-of-ai-engineering), if approved: humans and agents need a shared culture to build toward the same vision.</td>
</tr>
<tr>
<td>Aug. 19</td>
<td>This AI Alien Will Bring In \$4 Million This Year rerun</td>
<td>N/A</td>
<td>N/A</td>
</tr>
<tr>
<td>Aug. 21</td>
<td>AI Terminology</td>
<td>Establish “after automation” as memetic language for executives and operators.</td>
<td>[Dan Shipper](https://every.to/p/after-automation): “The more we automate, the more expert human work there is to do.” [Shoshana Berger](https://aged-intelligence.com/): “Like wine and cheese, intelligence improves over time,” and the current productivity-and-hacks frame is too narrow. AI Terminology is explicitly about the language we use; both statements introduce language that changes the frame.</td>
</tr>
<tr>
<td>Aug. 25</td>
<td>How I Write With AI</td>
<td>What remains human when writing is automated?</td>
<td>[Eliot Peper](https://every.to/thesis/ai-isn-t-only-a-tool-it-s-a-whole-new-storytelling-medium), if approved: “AI isn’t only a tool—it’s a whole new storytelling medium.” How I Write With AI shows the current workflow; Eliot pushes the conversation toward the new forms the technology makes possible.</td>
</tr>
<tr>
<td>Aug. 26</td>
<td>Compound Writing Guide and Writing Festival</td>
<td>N/A</td>
<td>Unless we have Katies Thesis to use here?</td>
</tr>
</table>
**DRI**: Douglas
**Before launch:**
...
Write, design, build, and QA:
- Both websites, their cross-links, and homepage takeover module.
- Public application page.
- Application received, acceptance, and rejection emails.
- Longer registration and payment form for accepted and directly invited guests.
- Payment confirmation email.
- A second confirmation email for non–All Access attendees that introduces the Builder Pack.
...
## Launch Assets
- Dan's article, launch post, video, and cutdowns.
- Every's launch post and speaker roster assets.
...
- Lock all the lifecycle emails: received, accepted, rejected, paid, and confirmed.
- Design and write contributor and speaker kits using only approved statements or quotes.
## Wednesday, Aug. 12: Test and Stage
- Test the public application and direct-invite paths from first click through payment confirmation.
- QA logged-in and logged-out states, links, tracking, suppression rules, and email rendering.
- Load the three announcement emails.
- Stage Dan's article, post, video, Every's launch posts, roster sequence, homepage module, and social assets.
- Send contributors and speakers their assets, suggested copy, links, and posting windows.
## Thursday, Aug. 13: Launch
1. Both websites, their cross-links, and the homepage module go live.
2. Dan publishes the article, video, and launch post.
3. Every amplifies the idea, introduces Thesis, and publishes the full confirmed speaker roster.
4. Free, paid, and All Access emails send once every destination has passed QA.
5. Thesis Statements contributors and speakers publish their assigned assets.
6. Every and Dan respond to strong statements, disagreements, nominations, and questions.
7. Becky collects the best responses for the next two days of programming.
8. P1 personal invitees remain suppressed from the generic emails; their direct invitations send Friday.
## Friday, Aug. 14: Begin the Sustain
...
<td>Provoke</td>
<td>Promote</td>
<td>Owner/Dependency</td>
</tr>
<tr>
<td>Thu, Aug. 13</td>
<td>Dan (re)introduces the After Automation paradox. Thesis Statements goes live by highlighting our top 3 that can spur the most debate. </td>
<td>Websites launch. Emails go out to Every list. Every promotes Thesis: 2027 with an announcement and then through Dan’s post/RT. We RT anyone who shares from speaker list. We respond to any comment. </td>
<td>Dan, Brandon, Douglas, Becky, and Yash. </td>
</tr>
<tr>
<td>Fri, Aug. 14</td>
<td>Post with three more of the strongest approved Thesis Statements from launch and invite responses. Highlight submit your own thesis on site, or respond directly to this tweet. We’ll highlight our favorites.</td>
<td>Send P1 personal invitations with the direct registration and payment link. Repost launch participation from speakers and contributors.</td>
<td>Kate selects the statement; Becky publishes; Douglas and Dan send invitations; Yash owns suppression.</td>
</tr>
<tr>
<td>Sat, Aug. 15</td>
<td>Publish the strongest public answer to “After Automation…” and ask readers to add theirs.</td>
<td>Highlight Nomination mechanic on social. </td>
<td>Becky. Requires a shortlist of launch responses/submitted Thesis Statements.</td>
</tr>
<tr>
<td>Sun, Aug. 16</td>
<td>Publish 3 more Thesis Statements on social with continued CTAs to submit your own. </td>
<td>Highlight Nomination mechanic on social. </td>
<td>Becky with Kate approval.</td>
</tr>
<tr>
<td>Mon, Aug. 17</td>
<td>Agent Etiquette asks what norms humans and agents need to work together. If approved, Noah Brier's statement argues that humans and agents need a shared culture to build toward the same vision.</td>
<td>Dan asks who should speak. </td>
<td>Dan, Kate and Becky. Noah's statement must be approved. </td>
</tr>
<tr>
<td>Tue, Aug. 18</td>
<td>Every asks, “Who should attend Thesis?” Nominators must explain what the person is building, operating, or thinking about. </td>
<td>Follow up with P1 nonresponders. Start P2 outreach based on missing roles, industries, and points of view.</td>
<td>Becky on nominations; Douglas and Dan on outreach.</td>
</tr>
<tr>
<td>Wed, Aug. 19</td>
<td>Publish the next approved Thesis Statement as its own campaign beat. The AI Alien rerun publishes separately, with no forced Thesis connection. </td>
<td>Use a speaker, contributor, or application story unrelated to the podcast to strengthen the case for attending. Build FOMO with an early-bird pricing reminder.</td>
<td>Kate selects the statement; Becky publishes. Editorial runs the podcast normally.</td>
</tr>
<tr>
<td>Thu, Aug. 20</td>
<td>Put two approved Thesis Statements in direct tension and ask the public where they land.</td>
<td>Build FOMO with an early-bird pricing reminder.</td>
<td>Kate + Becky. </td>
</tr>
<tr>
<td>Fri, Aug. 21</td>
<td>AI Terminology asks which language helps people understand work with AI. Dan supplies “after automation”; Shoshana Berger supplies “aged intelligence.” Highlight one or both to amplify conversation. </td>
<td>Dan highlights a new approved speaker. **Build - **Short form Video where the team discusses the Thesis statements most at odds with each other. </td>
<td>Kate, Dan, and Becky. Shoshana's statement is approved. Randy on video. </td>
</tr>
<tr>
<td>Sat, Aug. 22</td>
<td>Publish the best public thesis, reply, or disagreement of the week.</td>
<td>Repost useful attendee and speaker nominations with an application CTA.</td>
<td>Becky.</td>
</tr>
<tr>
<td>Sun, Aug. 23</td>
<td>Collect what the conversation has clarified and what remains unresolved.</td>
<td>Show how the roster and conversation have changed since launch.</td>
<td>Becky with Kate approval.</td>
</tr>
<tr>
<td>Mon, Aug. 24</td>
<td>Public polling - what would you most want to get out of Thesis: 2027? Dan frame/post. Less who should talk and more what would be useful to you.</td>
<td>Announce limited tickets (eg x have sold already) and tease programming at thesis more in-depth with assets eg for the Agora or Classroom.</td>
<td>Brandon supplies confirmed program or speaker facts; Douglas frames; Becky publishes. Daniel on design. </td>
</tr>
<tr>
<td>Tue, Aug. 25</td>
<td>How I Write With AI asks what remains human when writing is automated. If approved, Eliot Peper argues that AI is a new storytelling medium.</td>
<td>Connect Eliot's argument to the builders and creatives Thesis wants to attract. Use a new speaker announcement if one is ready.</td>
<td>Kate and Becky. Eliot's statement must be approved.</td>
</tr>
<tr>
<td>Wed, Aug. 26</td>
<td>Publish the strongest unresolved question from the first two weeks. The Compound Writing Guide and Writing Festival publish separately; Katie Thesis Statement push if approved.</td>
<td>Direct application push.</td>
<td>Kate, Becky, and Douglas.</td>
</tr>
</table>
# Social Brief
The working social brief lives here: <mention-page url="https://app.notion.com/p/3b6ca4f355ac81049e99fe1663c09e04">Thesis: 2027 Social Brief — Launch + First 2 Weeks</mention-page>.
It must translate the moments above into:
- Launch-day choreography for Dan, Every, speakers, and contributors.
- Thesis Statement post formats.
- Speaker announcement formats.
- Attendee and speaker nomination mechanics.
...
## Announcement
- [ ] Dan article, launch post, video, and cutdowns.
- [ ] Every launch post and speaker-roster sequence.
- [ ] Free announcement email.
- [ ] Paid announcement email.
- [ ] All Access announcement email.
- [ ] Homepage launch module and follow-up state.
- [ ] Thesis and Thesis Statements websites.
- [ ] Cross-links and CTAs between both sites.
## Personal Outreach
- [ ] Final P1 cohort.
- [ ] Sender assigned to every P1 name.
- [ ] P1 suppression list.
- [ ] Dan invitation template.
- [ ] Douglas invitation template.
- [ ] Follow-up template.
- [ ] Direct registration and payment link.
- [ ] Outreach tracker.
...
- [ ] Attendee nomination asset.
- [ ] Speaker nomination asset.
## Website and Application
- [ ] Public application form.
- [ ] Application-received email.
- [ ] Acceptance email.
- [ ] Rejection email.
- [ ] Accepted-attendee information and payment page.
- [ ] Payment confirmation email.
- [ ] Non–All Access confirmation featuring the Builder Pack.
- [ ] Direct-invitation flow for automatically approved guests.
- [ ] Logged-in and logged-out states.
- [ ] Homepage module.
- [ ] Full-flow QA.
# Working Sources
- [Aug. 7 Thesis launch meeting](https://app.notion.com/p/3b5ca4f355ac805b8784d202e29fc6db)
- [Current Thesis HQ](https://app.notion.com/p/36dca4f355ac80a4832acb839e71aa6e)
- [Brandon's original Thesis strategy (archived)](https://app.notion.com/p/36bca4f355ac80b08a96c84a135a17a7)
- [Thesis Statements GTM strategy](https://app.notion.com/p/3aaca4f355ac817e8661d72bfe78773b)
- [Thesis Statement contributor tracker](https://app.notion.com/p/a2d69aed2a2a41ecbd6b616b3b02b3cb)
- [Speaker funnel](https://app.notion.com/p/9560043780544561a4eebad2acb1302e)
- [Every editorial calendar](https://app.notion.com/p/465a4d6a351d4e949bd777e8b188938b)
