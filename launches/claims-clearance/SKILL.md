...
comparisons — and clears, flags, or blocks each one.
...
- **CONFLICTED** — two launch surfaces disagree. Conflicts block both surfaces until the
  owner rules; for pricing, that is Brandon and the product GM.
...
- Comparative claims about competitors require a live check dated within the launch
  window (`marketing-science/research/references/competitive-audits.md`), not memory.
...
- `marketing-science/research` (live re-verification of comparative claims)
